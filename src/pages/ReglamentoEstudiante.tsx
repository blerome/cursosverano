...
const ReglamentoEstudiante: React.FC = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content} ref={contentRef}>
        <div className={styles.contentSection}>
          <div>
            ...
            <p className={styles.justified}>
              Se entiende como Curso de Verano aquél que el Instituto Tecnológico de Cancún ofrece para sus estudiantes en la modalidad escolarizada, durante el período de receso de labores escolares en verano y de manera presencial, en concordancia con las asignaturas de las retículas vigentes y su finalidad es permitir al estudiante avanzar y/o regularizarse en su proceso formativo.
            </p>
        ...
        <div className={styles.contentSection}>
          <div>
            <h1>¿Cuántas Asignaturas Puedo Llevar?</h1>
            <h2>Dos asignaturas como máximo</h2>
            <p className={styles.justified}>
              Los alumnos que cumplan con los requisitos académico-administrativos, considerando los planes y programas de estudio.
            </p>
            <h2>   Solo podrán cursar una asignatura en verano</h2>
            <p className={styles.justified}>
            ✳Las y los estudiantes  que cursan los planes de estudio con enfoque de competencias profesionales cuando esta sea de opción de Curso Especial.
            </p>
            <p className={styles.justified}>
            ✳ podrán reinscribirse en la asignatura, como opción de Curso de Repetición (Sí el alumno NO acredita la asignatura en curso ordinario). Y como Curso Ordinario (es aquél que es cursado por primera vez).
            </p> 
             
             <p className={styles.justified}>
             ✳Las y los estudiantes que hayan causado baja temporal en el período
             semestral inmediato anterior al Curso de Verano, siempre y cuando su baja haya sido por un solo período semestral y soliciten su reactivación de matrícula en la División de Estudios Profesionales durante el mes de Mayo.
            </p> 
        ...
        <div className={styles.contentSection}>
          <div>
            ...
            <p className={styles.justified}>
              Los alumnos que requieran llevar una materia de otra carrera únicamente podrán realizarlo con la convalidadación autorizada por el Jefe Académico y siempre que no haya sido aperturada en su área.
            </p>
            <p className={styles.justified}>
...
export default ReglamentoEstudiante;