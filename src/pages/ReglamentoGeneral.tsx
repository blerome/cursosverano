...
const ReglamentoGeneral: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const wings = wingsRef.current.filter(Boolean) as SVGPathElement[];
      ...
      <div className={styles.content} ref={contentRef}>
        <div className={styles.contentSection}>
          <div>
            ...
            <p className={styles.justified}>
              La duración del Curso de Verano será equivalente al mismo número
              de horas que se imparten en un período semestral: 60, 75 y 90
              horas según los créditos de la asignatura.
            </p>

            <p className={`${styles.arrowAnimated}`} ref={arrowRef}>
              ↓
            </p>
          </div>
        </div>
        <div className={styles.contentSection}>
          <div>
            ...
            <h2>Integrantes</h2>
            <p className={styles.justified}>
              Los grupos en Curso de Verano podrán formarse con un máximo de 30
              alumnos (as) y un mínimo de 15 por asignatura, considerando 5
              lugares adicionales para los alumnos(as) en movilidad,
              provenientes de otros Institutos Tecnológicos.
            </p>

            <p className={styles.justified}>
              ✳Los objetivos y contenidos de las asignaturas impartidas en
              Cursos de Verano, deberán ser cubiertos al 100% en un lapso de
              cuatro a seis semanas de clases efectivas, incluyendo las
              evaluaciones, por lo que los Cursos de Verano iniciarán el 26 de
              Junio y finalizarán el 4 de Agosto del presente año.
            </p>
          </div>
        </div>
        <div className={styles.contentSection}>
          <div>
            <h1>Costos</h1>
            <p className={styles.justified}>
              El costo por alumno para los Cursos de Verano, dependerá del
            ...
            <p className={styles.justified}>Cubrir la cuota correspondiente.</p>
          </div>
        </div>
      </div>
