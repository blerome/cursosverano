      ...
      <div className={styles.content} ref={contentRef}>
        <div className={styles.contentSection}>
          <div>
            ...
            <p className={styles.justified}>
              Los responsables de los Cursos de Verano deberán garantizar que se
              cumplan los objetivos académicos y los contenidos programáticos en
        ...
        <div className={styles.contentSection}>
          <div>
            ...
            <h2>Docentes</h2>
            <p className={styles.justified}>
              Los profesores responsables deberán presentar un plan de trabajo
              detallado, cumplir con el horario establecido y evaluar a los
              estudiantes según los criterios definidos por la institución.
            </p>

            <p className={styles.justified}>
              ✳Es responsabilidad del docente mantener actualizada la plataforma
              educativa con los materiales y actividades programadas para cada
              sesión.
            </p>
          </div>
        </div>
        <div className={styles.contentSection}>
          <div>
            <h1>Coordinación</h1>
            <p className={styles.justified}>
              La coordinación académica supervisará el desarrollo de los cursos
              y deberá:
            </p>
            <table>
              <tbody>
            ...
            <p className={styles.justified}>
              El incumplimiento de estas responsabilidades podrá ser motivo de
